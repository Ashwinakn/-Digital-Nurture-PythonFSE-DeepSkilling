...
// Step 83: Consume context in ProfilePage to display list of enrolled courses
// Step 84: Add a Remove button that calls unenroll() from context to un-enroll
...
function ProfilePage() {
  ...
  return (
    <div className="page" style={{ display: "flex", gap: "2rem", flexWrap: "wrap" }}>
      ...
      {/* Enrolled Courses list display from context */}
      <div style={{ flex: "1 1 400px" }}>
              ...
              <ul className="enrolled-list" style={{ listStyleType: "none", padding: 0 }}>
                {enrolledCourses.map((course) => (
                  ...
                  >
                    ...
                    {/* Step 84: Remove button calling unenroll() */}
                    <button
